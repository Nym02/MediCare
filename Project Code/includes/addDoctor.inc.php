...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO doctors(doc_Fullname, doc_Specialization1, doc_Specialization2,doc_Degree,doc_Time1,doc_Time2,doc_Time3, doc_Email,doc_PhoneNumber,doc_Description)  VALUES (?,?,?,?,?,?,?,?,?,?)";
