...
<head>
    ...
    <title>Search Doctor || MediCare</title>
...
<body>
    ...
    <section class="form">
        <div class="form-body">
                    ...
                    <form action="includes/search.inc.php" method="POST" onsubmit="return docRegValidation();" class="form-area">
                            <div class="form-header">
                                    <h3 class="mb-5">Search Doctor</h3>
                                </div>
