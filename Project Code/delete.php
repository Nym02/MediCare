    ...
    <div class="table-responsive-md table-responsive-lg table-responsive-xl table-responsive-sm ">
      <table class="table ">
        ...
        while ($row = mysqli_fetch_array($result)) {
          ...
          echo "<tr class='text-center'><form  action='includes/delete.inc.php'  method=POST>";
          echo "<td><input class='' type=text name=id value='" . $row['userID'] . "'</td>";
          echo "<td><input class='' type=text name=Name value='" . $row['userFullName'] . "'</td>";
          echo "<td><input class='' type=text name=uid value='" . $row['userName'] . "'</td>";
          echo "<td><input class='' type=text name=email value='" . $row['userEmail'] . "'</td>";

          echo "<td><input class='btn btn-danger btn-sm' type=submit value=Delete>";
