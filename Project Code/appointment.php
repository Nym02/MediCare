                ...
                <div class="col-md-6">
                    <div class="appointmentForm">
                        <form action="" method="POST" onsubmit="return docRegValidation();" class="form-area">
                            ...
                            <input type="text" id="docName" name="docName" placeholder="Enter Doctor Name" value="<?php echo $row2['doc_Fullname'] ?>">
                            ...
                            <input class="btn btn-danger " type="submit" name="submit" value="Make Appointment" />
                        </form>
                    </div>
                </div>
                <?php } ?>
